...
import (
	...
	"github.com/50u7h/Go-Bookings/internal/driver"
	"github.com/50u7h/Go-Bookings/internal/forms"
	...
	"github.com/50u7h/Go-Bookings/internal/repository/dbrepo"
	"log"
	"net/http"
	"strconv"
	"strings"
...
func (m *Repository) PostShowLogin(w http.ResponseWriter, r *http.Request) {
	...
	m.App.Session.Put(r.Context(), "flash", "Logged is successfully")
...
// AdminShowReservation show single reservation with details
...
// AdminReservationsCalendar displays the reservation claendar
